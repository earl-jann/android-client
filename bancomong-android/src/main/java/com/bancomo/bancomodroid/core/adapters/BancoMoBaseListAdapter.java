...
package com.bancomo.bancomodroid.core.adapters;
...
public abstract class BancoMoBaseListAdapter<T> extends BaseAdapter {
    ...
    public BancoMoBaseListAdapter(Context context, List<T> list, int layoutId) {
