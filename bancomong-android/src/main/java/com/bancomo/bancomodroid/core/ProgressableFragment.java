...
/**
 * A {@link BancoMoBaseFragment} that provides progress viewing functionality with a ViewFlipper.
 */
public class ProgressableFragment extends BancoMoBaseFragment {
