...
import com.bancomo.bancomodroid.adapters.CentersListAdapter;
 ...
 * </>demo.openmf.org/bancomo-provider/api/v1/centers?paged=true&offset=0&limit=100</>
 */
public class CenterListFragment extends BancoMoBaseFragment
    ...
    void onClickCreateNewCenter() {
        ((BancoMoBaseActivity) getActivity()).replaceFragment(CreateNewCenterFragment.newInstance(),
                true, R.id.container);
    }
