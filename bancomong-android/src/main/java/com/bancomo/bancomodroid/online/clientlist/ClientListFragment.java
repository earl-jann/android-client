...
import com.bancomo.bancomodroid.adapters.ClientNameListAdapter;
import com.bancomo.bancomodroid.core.EndlessRecyclerOnScrollListener;
...
import com.bancomo.bancomodroid.core.RecyclerItemClickListener.OnItemClickListener;
 ...
 * from Rest API
 * <p>
 * </>demo.openmf.org/bancomo-provider/api/v1/clients?paged=true&offset=offset_value&limit
 * =limit_value</>
 * <p>
 ...
 */
public class ClientListFragment extends BancoMoBaseFragment
    ...
    void onClickCreateNewClient() {
        ((BancoMoBaseActivity) getActivity()).replaceFragment(CreateNewClientFragment.newInstance(),
                true, R.id.container);
    }
    ...
    /**
     * show BancoMoBaseActivity ProgressBar, if mClientNameListAdapter.getItemCount() == 0
