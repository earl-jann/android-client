...
import com.bancomo.api.model.BulkRepaymentTransactions;
...
import com.bancomo.bancomodroid.adapters.CollectionListAdapter;
 ...
 */
public class CollectionSheetFragment extends BancoMoBaseFragment implements CollectionSheetMvpView {
...
//                .actionBarSize());
    ...
    public void showCollectionSheet(CollectionSheet collectionSheet) {
        ...
        List<BancoMoGroup> bancoMoGroups = collectionSheet.groups;
        collectionListAdapter = new CollectionListAdapter(getActivity(), bancoMoGroups);
