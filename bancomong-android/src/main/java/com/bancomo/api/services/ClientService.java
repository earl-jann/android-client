...
import com.bancomo.objects.client.ClientAddressRequest;
...
import com.bancomo.objects.noncore.IdentifierPayload;
...
//    Observable<TypedString> getClientImage(@Path("clientId") int clientId);
     ...
     * REST END POINT:
     * https://demo.openmf.org/bancomo-provider/api/v1/clients/{clientId}/identifiers
     *
     ...
     * REST END POINT:
     * https://demo.openmf.org/bancomo-provider/api/v1/clients/{clientId}/identifiers/template
     *
     * @param clientId Client Id
     ...
     * 4. longitude
     * REST END POINT:
     * https://demo.openmf.org/bancomo-provider/api/v1/datatables/client_pinpoint_location
     * /{appTableId}
     *
     * @param clientId Client Id
     ...
     * REST ENT POINT
     * https://demo.openmf.org/bancomo-provider/api/v1/clients/{clientId}?command=activate
     *
     * @param clientId
     * @return GenericResponse
     */
