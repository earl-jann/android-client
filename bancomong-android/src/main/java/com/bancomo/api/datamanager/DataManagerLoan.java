...
public class DataManagerLoan {
     ...
     * {https://demo.openmf.org/bancomo-provider/api/v1/loans/{loanId}/transactions/template
     * ?command=repayment}
     ...
     * {https://demo.openmf.org/bancomo-provider/api/v1/loans/{loanId}/transactions?command
     * =repayment}
