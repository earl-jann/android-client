...
public class DataManagerSurveys {
     ...
     * https://demo.openmf.org/bancomo-provider/api/v1/surveys and fetch the list of surveys and
     ...
     * https://demo.openmf.org/bancomo-provider/api/v1/surveys/{surveyId}/scorecards
