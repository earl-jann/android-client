package com.bancomo.objects.templates.clients;
 ...
 */
@Table(database = BancoMoDatabase.class, name = "ClientTemplateSavingProductsOptions")
@ModelContainer
public class SavingProductOptions extends BancoMoBaseModel implements Parcelable {
