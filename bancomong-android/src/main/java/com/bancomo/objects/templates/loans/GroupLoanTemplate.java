...
public class GroupLoanTemplate implements Parcelable {
    ...
    com.bancomo.objects.templates.loans.Group group;
    ...
    public com.bancomo.objects.templates.loans.Group getGroup() {
        return group;
    }

    public void setGroup(com.bancomo.objects.templates.loans.Group group) {
        this.group = group;
    }
    ...
    protected GroupLoanTemplate(Parcel in) {
        this.group = in.readParcelable(com.bancomo.objects.templates.loans.Group.class
                .getClassLoader());
