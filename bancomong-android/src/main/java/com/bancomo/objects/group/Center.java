...
package com.bancomo.objects.group;
...
import com.bancomo.objects.Timeline;
import com.bancomo.objects.client.Status;
 ...
 */
@Table(database = BancoMoDatabase.class)
@ModelContainer
public class Center extends BancoMoBaseModel implements Parcelable {
